/*
	This Admin Controller is the controller for the Admin UI.
	It is divided into two sections: Manage Products and Manage Users.
	routes: /admin/products , /admin/users
*/
...
/*
	****** MANAGE PRODUCTS SECTION ******
	...
	1. render 'List of Products' page
	2. render 'Add New Product' form
		2a. create New Product
	3. render 'Edit Product' form
		3a. save Product
	4. delete Product
*/

// Get index of admin products
module.exports.adminDisplayProducts = (req, res, next) => {
...
module.exports.adminAddProduct = (req, res, next) => {
	res.render('admins/adminAddProduct',
		{ title: "Add a product" });
};

// creates a new admin product
module.exports.adminSaveProduct = (req, res, next) => {
...
module.exports.adminEditProduct = (req, res, next) => {
...
module.exports.adminSaveAfterEdit = (req, res, next) => {
	let id = req.params.id;
	var qty = req.body.quantity;
	var price = req.body.price;
...
// deletes a product
module.exports.adminDeleteProduct = (req, res, next) => {
	let id = req.params.id;
...
/*
  ****** MANAGE USERS SECTION ******
  This section provides the following functionalities: 
  1. render 'List of Users' page
  2. render 'User's Order History' page
  3. delete a user's order
  4. render 'Edit User's Order' form
      4a. save Edit User's Order
  5. 
*/

// GET index of users
module.exports.adminDisplayUsers = (req, res, next) => {
	User.find({}, (err, users) => {
		if (err)
			console.log("Error : %s ", err);
...
module.exports.adminDisplayOrders = (req, res, next) => {
...
// deletes an order
module.exports.adminDeleteOrder = (req, res, next) => {
...
module.exports.adminEditOrder =  (req , res , next) => {
	let id = req.params.id;
...
// updateUserOrder() update quantities in product & order collections when user adds\removes items
