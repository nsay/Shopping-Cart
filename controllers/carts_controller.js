/*
	This Cart Controller is the controller for the Cart UI.
	route: /cart
*/
	...
	****** CARTS SECTION ******
	This section provides the following functionalities: 
		1. save product to cart:
			1a. Get product id
			1b. find product in database
			1c. check if product is already in cart
			1c. update cart
		2. show user's cart
		3. empty user's cart
*/
...
module.exports.saveProductToCart = (req, res, next) => {
